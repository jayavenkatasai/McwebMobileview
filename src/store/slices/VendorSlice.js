...
export const fetchVendorToken = createAsyncThunk("vendor/fetchVendorToken", async (vendorId) => {

    const response = await fetch(`${apiurl}/api/ExpoChat/vendor`, {
        method: "POST",
        headers: {
...
const vendorSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchVendorToken.pending, (state) => {
            state.loading = true;
            state.error = null;
        })
